...
const float CALIBRATION_FACTOR = 14.5; // Factor de calibración para convertir a onzas
const float MIN_FORCE = 0.0; // Fuerza mínima en el sensor
const float MAX_FORCE = 1000.0; // Fuerza máxima en el sensor
